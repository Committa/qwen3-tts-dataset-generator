...
| `language` | `Italian` | Language name (`italian`, `english`, ...) or ISO 639-1 2-letter code (`it`, `en`, ...). `Auto` is **not** supported — it disables WER text normalisation and produces inaccurate results. |
